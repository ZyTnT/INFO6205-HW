    ...
    public void part3() {
        ...
        for(int i=0; i<10000;i++){
            if(i<5000){
                ...
                partiallyRandomList.add(random.nextInt(10000-5000)+5000);
            }
        ...
        System.out.println("listSize=10000, " + "random" + randomSortedList);
        System.out.println("listSize=10000, " + "ordered" + orderedSortedList);
        System.out.println("listSize=10000, " + "partiallyOrdered"+ partially_orderSortedList);
        System.out.println("listSize=10000, " + "reverseOdered" + reverse_orderSortedList);
    }
