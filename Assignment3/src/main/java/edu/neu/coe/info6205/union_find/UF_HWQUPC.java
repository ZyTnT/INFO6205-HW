...
public class UF_HWQUPC implements UF {
    ...
    public int find(int p) {
        ...
        if (this.pathCompression) {
            while (this.parent[root] != root) {
                this.doPathCompression(root); // Path compression
    ...
    private void mergeComponents(int i, int j) {
        ...
        if(this.height[iRoot] >= this.height[jRoot]) {
            this.parent[jRoot] = this.parent[iRoot];
            this.height[iRoot] += this.height[jRoot];
        }
        else{
            this.parent[iRoot] = this.parent[jRoot];
            this.height[jRoot] += this.height[iRoot];
        }
    }
